...
subject.lessons = [0, 1, 2, 3].map((value) => ({id: value, title: `Lesson ${value}`, grades:[], description: 'Something', startTime: new Date(), endTime: new Date(), subject: subject, virtualEntities: []}));
