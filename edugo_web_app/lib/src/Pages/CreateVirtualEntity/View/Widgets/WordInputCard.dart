...
class WordInputCard extends StatefulWidget {
  ...
  @override
  _WordInputCardState createState() => _WordInputCardState();
}

class _WordInputCardState extends State<WordInputCard> {
                  ...
                  child: Form(
                    ...
                    child: SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        onFieldSubmitted: (value) {
                          if (quizBuilder.questions[widget.questionId]
                            ...
                            showDialog(
                              ...
                              .validate()) {
                            WordInputCard._controller.clear();
                        ...
                        controller: WordInputCard._controller,
                        onChanged: (value) {
                          Momentum.controller<QuizBuilderController>(context)
                              .editWord(
                                  questionID: widget.questionId,
                        ...
                        decoration: InputDecoration(
                            ...
                            hintText: "Enter missing word option..."),
                      ),
                    ),
                  ),
                ),
