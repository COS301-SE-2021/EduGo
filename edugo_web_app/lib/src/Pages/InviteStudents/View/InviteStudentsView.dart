...
class InviteStudentsView extends StatefulWidget {
  @override
  _InviteStudentsViewState createState() => _InviteStudentsViewState();
}

class _InviteStudentsViewState extends State<InviteStudentsView> {
    ...
    return MomentumBuilder(
      ...
      builder: (context, snapshot) {
        ...
        Future<String> subjectsLoaded = Future<String>.delayed(
          ...
          () {
            if (subjects.subjectCards.isEmpty) return null;
            return "Data loaded";
          },
        );
        Future<String> sendingInvitations = Future<String>.delayed(
          const Duration(seconds: 0),
          () {
            if (students.inviteResponse.isEmpty) return null;
            return students.inviteResponse;
          },
        );
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    InviteStudentsButton(
                                        ...
                                        onPressed: () async {
                                          if (students.emails.isEmpty ||
                                              students.subjectName == null)
                                            _emptyEmailError();
                                          else
