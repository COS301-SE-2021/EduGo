              ...
              children: <Widget>[
                ...
                Align(
                  ...
                  child: Container(
                    ...
                    width: 100,
                    decoration:
                        BoxDecoration(color: Color.fromRGBO(55, 59, 83, 1)),
                    child: Column(
                          ...
                          children: <Widget>[
                            ...
                            MouseRegion(
                              ...
                              child: GestureDetector(
                                child: Icon(
                                    currentOrganisation.currentUser.getAdmin()
                                        ? Icons.home_outlined
                        ...
                        MouseRegion(
                          ...
                          child: GestureDetector(
                            child: Icon(Icons.logout_outlined,
                                size: 30, color: Colors.white),
                            onTap: () async {
                              await MomentumRouter.resetWithContext<Home>(
                                  context);
