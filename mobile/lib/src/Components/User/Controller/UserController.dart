...
class UserController extends MomentumController<UserModel> {
  ...
  Future<bool> verify({required String email, required String code}) {
    final api = service<UserApiService>();
    return api.verify(email: email, code: code, client: mock == true ? httpMock.MockClient(mockApi.verify) : http.Client());
  }
  ...
  Future<bool> register({
    ...
    required String type
      ...
      return api.register(
        ...
        type: type, 
        client: mock == true ? httpMock.MockClient(mockApi.register) : http.Client());
    }
